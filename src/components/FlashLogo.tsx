      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 240" className={`${sizeMap[size]} w-auto`}>
        <defs>
          <linearGradient id="blueGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--color-brand-primary, #2563EB)" />
            <stop offset="100%" stopColor="var(--color-brand-primary, #2563EB)" />
          </linearGradient>
          <linearGradient id="greenGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--color-brand-success, #10B981)" />
            <stop offset="100%" stopColor="var(--color-brand-success, #10B981)" />
          </linearGradient>
        </defs>
        ...
        <g transform="translate(10, 35)">
          ...
          <circle cx="70" cy="165" r="7" fill="var(--color-brand-primary, #2563EB)"/>
          <circle cx="130" cy="165" r="7" fill="var(--color-brand-success, #10B981)"/>
        </g>

        {/* Texto */}
        <text x="220" y="138" fontFamily="Inter, system-ui, sans-serif" fontWeight="900" fontSize="86" letterSpacing="-2">
          <tspan fill="var(--color-brand-primary, #2563EB)">W</tspan><tspan className={textColorClass}>commerce</tspan>
        </text>
      </svg>
      {showSubtitle && (
